...
export const eventDb: Record<string, Event> = {
  ...
  "langchain-101": { //events/langchain-101 is the route
    name: "Langchain 101", 
  ...
  "acm-student-chapter-induction-2024": { //events/acm-student-chapter-induction-2024 is the route
    ...
    gallery: ["/induction 2024/induction 2.jpg", "/induction 2024/induction 3.jpg", "/induction 2024/induction 4.jpg", "/induction 2024/induction 5.png"],
  ...
  "generative-ai-workshop": { //events/generative-ai-workshop is the route
  ...
  "how-to-win-a-hackathon": {//events/how-to-win-a-hackathon is the route
    ...
    stats: [{ value: 80, prefix: "Attendance exceeded ", suffix: " Participants" }], 
    gallery: ["/how to win hack/how to win hack 2.jpg"],
    tags: ["#Hackathon", "#TeamFormation", "#AITools", "#Ideation", "#TechStack"],
  },

  "git-github-foundations-workshop": {//events/git-github-foundations-workshop is the route
